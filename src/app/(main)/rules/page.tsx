...
const runRules = [
  ...
  "No overlays of any kind may cover the video. Images, PNGs, videos, webcams, stream layouts, and any other element drawn over the footage are not allowed — the run must be visible exactly as it was recorded.",
